...
export class SourceList {
  ...
  public static async render(extensionUri: Uri, workspaceUri: Uri, source_list_file: string) {
    ...
    let filtered_sources_extended = await lbtTools.get_filtered_sources_with_details(source_list_file) || [];
    ...
    const html = nunjucks.render('source_list/index.html',
      {
        global_stuff: lbtTools.get_global_stuff(panel.webview, extensionUri),
