...
description: >
  Generates flowcharts, process diagrams, and other visuals using Mermaid or
  Draw.io. Use this skill when a user asks to create or visualize a process,
  workflow, or diagram (especially if they mention "Mermaid", "draw.io", or
  need an image for documentation). The skill decides the appropriate format
  and provides the diagram definition along with guidance to export it as PNG/SVG.
license: MIT
---
